#ifndef BINCONVOLVEBIBO
#define BINCONVOLVEBIBO

#include "Halide.h"

using namespace Halide;

class BinConvolveBIBO {
    ...
    Target t;
public:
    BinConvolveBIBO(int w, int h, int channels, int filters, int size, int stride, bool pad, bool gpu = false) :
    ...
    void realize(int64_t *in_array, float *weight_array, int64_t *out_array) {
